import { Files, Terminal, Blocks, Activity, GitCommitHorizontal, GitBranch, Server, Brain, Wallet, LayoutDashboard } from "lucide-react";
...
const TOOLS: ToolStripItem[] = [
  ...
  { id: "spending", icon: Wallet, label: "Spending" },
